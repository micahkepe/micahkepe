...
DESCRIPTION
    Recent Rice University CS grad. Software engineer. Rustacean.
...
SEE ALSO
    ...
    jsongrep(1)
        JSONPath-inspired query language over JSON documents.
        Command-line tool for JSON manipulation and querying.
